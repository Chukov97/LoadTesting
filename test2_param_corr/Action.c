...
/*Correlation comment - Do not change!  Original value='130987.086107736zHDHztipctVzzzzHtAtcfpiiQtf' Name ='userSession' Type ='ResponseBased'*/
	...
	lr_end_transaction("Bilet", LR_AUTO);
